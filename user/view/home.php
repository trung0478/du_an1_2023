                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up" data-aos-delay="200">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            ...
                                            <a href="index.php?act=<?=$ma_sp?>" class="action quickview add-to-cart" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">Thêm vào giỏ hàng</a>
                                        </div>
                                        <div class="content">
