                    ...
                    <div class="card">
                        <div class="card-body">
                                ...
                                <table class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <img src="../admin/public/assets_admin/images/users/avatar-1.jpg" alt=""
                                                    class="thumb-sm rounded-circle mr-2"> Kevin Heal
                                            </td>
                                            <td>Paypal</td>
                                            <td>5/8/2018</td>
                                            <td>$15,000</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="../admin/public/assets_admin/images/users/avatar-3.jpg" alt=""
                                                    class="thumb-sm rounded-circle mr-2"> Angelo Butler
                                            </td>
                                            <td>Pioneer</td>
                                            <td>30/9/2018</td>
                                            <td>$45,000</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="../admin/public/assets_admin/images/users/avatar-4.jpg" alt=""
                                                    class="thumb-sm rounded-circle mr-2"> Phillip Morse
                                            </td>
                                            <td>Paypal</td>
                                            <td>2/6/2018</td>
                                            <td>$70,000</td>
                                        ...
                                        <tr>
                                            <td>New Office Building</td>
                                            <td>
                                                <img src="../admin/public/assets_admin/images/users/avatar-6.jpg" alt=""
                                                    class="thumb-sm rounded-circle mr-2"> Frank M. Lyons
                                            </td>
                                            <td>Paypal</td>
                                            <td>15/7/2018</td>
                            ...
                            <div class="pt-3 border-top text-right">
                                <a href="#" class="text-primary">View all <i class="mdi mdi-arrow-right"></i>
                                </a>
                            </div>
                        </div>
                    </div>
